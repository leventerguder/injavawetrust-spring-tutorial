package _39.aspectj.hibernate.transaction.test;
...
import _39.aspectj.hibernate.transaction.service.CustomerService;

public class AspectJHibernateTransactionTest {

	public static void main(String[] args) {

		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("39.aspectj.hibernate.transaction.xml");
